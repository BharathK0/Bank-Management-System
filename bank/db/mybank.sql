...
INSERT INTO `useraccounts` (`id`, `email`, `password`, `name`, `balance`, `vid`, `number`, `city`, `address`, `source`, `accountNo`, `branch`, `accountType`, `date`) VALUES
